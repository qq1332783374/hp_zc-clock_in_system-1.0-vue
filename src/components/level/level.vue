<template>
  <div class="level">
    ...
    <el-table :data="levelInfo" style="width: 100%">
      <el-table-column label="序号号" width="180">
      ...
      <el-table-column label="基本月薪/元" width="180">
        <template slot-scope="scope">
      ...
      <el-table-column label="级别最低积分" width="180">
        <template slot-scope="scope">
      ...
      <el-table-column label="绩效考核系数" width="380">
        <template slot-scope="scope">
      ...
      <el-table-column label="操作">
        ...
        <template slot-scope="scope">
          <el-button size="mini" type="success" @click="alterLevel(scope.$index, scope.row)">修改</el-button>
    ...
    <el-dialog title='修改等级基本工资' :visible.sync="levelShow" width="30%" :before-close="handlelevel">
      <div>
